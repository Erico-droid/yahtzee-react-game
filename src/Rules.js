...
class FullHouse extends Rule{
  evalRoll = dice => {
    var object = {};
    for (var i = 0; i < 5; i++) {
      if (object[dice[i]]) object[dice[i]]++;
      else object[dice[i]] = 1;
    }
    if (Object.keys(object).length <= 2) {
      if ((object[Object.keys(object)[0]] === 2 && object[Object.keys(object)[1]] === 3) ||
      (object[Object.keys(object)[0]] === 3 && object[Object.keys(object)[1]] === 2)) {
        return this.score
      }
    }
    return 0
